function out = P_mu_3_free_alpha(z,h,aalpha,sigma0)

% Calculates normalized fast muon production 
% as a function of depth below the surface z (g/cm2), 
% site atmospheric pressure h (hPa), alpha, and sigma0. 
% Used for He-3 fitting calculations. 
% 
% syntax out = P_mu_total(z,h,alpha,sigma0);
%
% Assumes Natoms (target atoms/g) is 2.7373e+22 (because mean atomic 
% weight of basalt is 22). That is, all atoms are targets. 
%
% returns P_fast (atoms/g/yr)
%
...
% 
%
% Originally written by Greg Balco -- UW Cosmogenic Nuclide Lab
...
% 
% This version 20210630
%
% This has been hacked up to have sigma0 and alpha as inputs. Not
% interchangable with normal P_mu_total_XXX.
%
% Only does fast muon production, I think. 

% what version is this?

ver = 'test for He-3 production';
...
P_fast = phi.*Beta.*(Ebar.^aalpha).*sigma0.*2.7373e+22;
